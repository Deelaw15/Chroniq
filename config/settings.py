...
def _resolve_base_dir() -> Path:
    ...
    (%APPDATA%\\Chroniq), which persists across restarts, updates,
    and reinstalls.

    One-time migration: this app was previously named "Focus Tracker"
    and stored data in %APPDATA%\\FocusTracker. If that folder exists
    and the new one doesn't yet, its contents are moved over so early
    testers don't lose their tracked history just because of the
